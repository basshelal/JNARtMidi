...
public interface RtMidiLibrary extends Library {
     ...
     */
    public double rtmidi_in_get_message(RtMidiInPtr device, int[] message, NativeSizeByReference size);
     ...
     */
    public int rtmidi_out_send_message(RtMidiOutPtr device, int[] message, int length);
