...
/**
 * JNA Wrapper for library <b>rtmidi</b><br>
...
public interface RtMidiLibrary extends Library {
    ...
    // TODO: 15/02/2021 Put types such as structs, pointers, callbacks etc

    //endregion Types

    //region Functions

    // TODO: 15/02/2021 Put global functions

    //endregion Functions


    public static final String JNA_LIBRARY_NAME = "rtmidi";
    public static final NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(RtMidiLibrary.JNA_LIBRARY_NAME);
    public static final RtMidiLibrary INSTANCE = (RtMidiLibrary) Native.loadLibrary(RtMidiLibrary.JNA_LIBRARY_NAME, RtMidiLibrary.class);
     ...
     * <i>native declaration : rtmidi_c.h:58</i><br>
     *
     * @deprecated use the safer methods {@link #rtmidi_get_compiled_api(java.nio.IntBuffer, int)} and {@link #rtmidi_get_compiled_api(com.sun.jna.ptr.IntByReference, int)} instead
     */
    @Deprecated
    public int rtmidi_get_compiled_api(IntByReference apis, int apis_size);
     ...
     * <i>native declaration : rtmidi_c.h:86</i><br>
     *
     * @deprecated use the safer methods {@link #rtmidi_open_port(rtmidi.RtMidiWrapper, int, java.lang.String)} and {@link #rtmidi_open_port(rtmidi.RtMidiWrapper, int, com.sun.jna.Pointer)} instead
     */
    @Deprecated
    public void rtmidi_open_port(RtMidiWrapper device, int portNumber, Pointer portName);
     ...
     * <i>native declaration : rtmidi_c.h:94</i><br>
     *
     * @deprecated use the safer methods {@link #rtmidi_open_virtual_port(rtmidi.RtMidiWrapper, java.lang.String)} and {@link #rtmidi_open_virtual_port(rtmidi.RtMidiWrapper, com.sun.jna.Pointer)} instead
     */
    @Deprecated
    public void rtmidi_open_virtual_port(RtMidiWrapper device, Pointer portName);
     ...
     * <i>native declaration : rtmidi_c.h:129</i><br>
     *
     * @deprecated use the safer methods {@link #rtmidi_in_create(int, java.lang.String, int)} and {@link #rtmidi_in_create(int, com.sun.jna.Pointer, int)} instead
     */
    @Deprecated
    public RtMidiWrapper rtmidi_in_create(int api, Pointer clientName, int queueSizeLimit);
     ...
     * <i>native declaration : rtmidi_c.h:166</i><br>
     *
     * @deprecated use the safer methods {@link #rtmidi_in_get_message(rtmidi.RtMidiWrapper, java.nio.ByteBuffer, com.ochafik.lang.jnaerator.runtime.NativeSizeByReference)} and {@link #rtmidi_in_get_message(rtmidi.RtMidiWrapper, com.sun.jna.Pointer, com.ochafik.lang.jnaerator.runtime.NativeSizeByReference)} instead
     */
    @Deprecated
    public double rtmidi_in_get_message(RtMidiWrapper device, Pointer message, NativeSizeByReference size);
     ...
     * <i>native declaration : rtmidi_c.h:181</i><br>
     *
     * @deprecated use the safer methods {@link #rtmidi_out_create(int, java.lang.String)} and {@link #rtmidi_out_create(int, com.sun.jna.Pointer)} instead
     */
    @Deprecated
    public RtMidiWrapper rtmidi_out_create(int api, Pointer clientName);
     ...
     * <i>native declaration : rtmidi_c.h:196</i><br>
     *
     * @deprecated use the safer methods {@link #rtmidi_out_send_message(rtmidi.RtMidiWrapper, byte[], int)} and {@link #rtmidi_out_send_message(rtmidi.RtMidiWrapper, com.sun.jna.Pointer, int)} instead
     */
    @Deprecated
    public int rtmidi_out_send_message(RtMidiWrapper device, Pointer message, int length);
    ...
    public interface RtMidiCCallback extends Callback {
        void invoke(double timeStamp, Pointer message, NativeSize messageSize, Pointer userData);
    }
