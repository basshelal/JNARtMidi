...
public class RtMidiLibraryNative implements RtMidiLibrary {
    ...
    @Override
    public native int rtmidi_get_compiled_api(IntByReference apis, int apis_size);
    ...
    @Override
    public native void rtmidi_open_port(RtMidiWrapper device, int portNumber, Pointer portName);

    @Override
    public native void rtmidi_open_port(RtMidiWrapper device, int portNumber, String portName);

    @Override
    public native void rtmidi_open_virtual_port(RtMidiWrapper device, Pointer portName);
    ...
    @Override
    public native RtMidiWrapper rtmidi_in_create(int api, Pointer clientName, int queueSizeLimit);
    ...
    @Override
    public native double rtmidi_in_get_message(RtMidiWrapper device, Pointer message, NativeSizeByReference size);
    ...
    @Override
    public native RtMidiWrapper rtmidi_out_create(int api, Pointer clientName);
    ...
    @Override
    public native int rtmidi_out_send_message(RtMidiWrapper device, Pointer message, int length);
