 ...
 *
 * To use the library use [RtMidiLibraryJNR.instance].
 *
...
interface RtMidiLibraryJNR {
    ...
    companion object {
        ...
        /**
         * The instance of [RtMidiLibraryJNR] that corresponds to the RtMidi Native Library with functions "implemented".
         ...
         */
        @JvmStatic
        val instance: RtMidiLibraryJNR by lazy {
